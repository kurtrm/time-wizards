...
robotIntroductionEl.textContent = 'Hello ' + playerName + '! ' + 'My name is JSON Timeberlake and a discrepancy in my Subatomic-Unilateral-Concatenating-Kaleidoscope has ruptured the delicate balance of space time. Time warp holes have been created and parts of my S.U.C.K have been scattered. You must travel through these warp holes and retrieve my missing parts and fix my S.U.C.K. Each warp hole will send you to an unknown location, so beware!';
